public void ch1_on() {
  if (connectedSerial) {
      ...
      serial.write('q');  println("type 'q'");  status_text("Ch1 on");   delay(20);
      twitter_send("The Ch1 is turned on !! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch1_off() {
  ...
  if (connectedSerial) {
    ...
    serial.write('a'); println("type 'a'"); status_text("Ch1 off"); delay(20);
    twitter_send("The Ch1 is turned off!! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch2_on() {
  if (connectedSerial) {
      ...
      serial.write('w');  println("type 'w'");  status_text("Ch2 on");   delay(20);
      twitter_send("The Ch2 is turned on !! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch2_off() {
  ...
  if (connectedSerial) {
    ...
    serial.write('s'); println("type 's'"); status_text("Ch2 off"); delay(20);
    twitter_send("The Ch2 is turned off!! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch3_on() {
  if (connectedSerial) {
      ...
      serial.write('e');  println("type 'e'");  status_text("Ch3 on");   delay(20);
      twitter_send("The Ch3 is turned on !! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch3_off() {
  ...
  if (connectedSerial) {
    ...
    serial.write('d'); println("type 'd'"); status_text("Ch3 off"); delay(20);
    twitter_send("The Ch3 is turned off!! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch4_on() {
  if (connectedSerial) {
      ...
      serial.write('r');  println("type 'r'");  status_text("Ch4 on");   delay(20);
      twitter_send("The Ch4 is turned on !! This is a tweet sent from SRCROOF_R01!! ");
  }
...
public void ch4_off() {
  ...
  if (connectedSerial) {
    ...
    serial.write('f'); println("type 'f'"); status_text("Ch4 off"); delay(20);
    twitter_send("The Ch4 is turned off!! This is a tweet sent from SRCROOF_R01!! ");
  }
